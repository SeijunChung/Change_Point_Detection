...
for itt in range(6):
    ...
    for num_clusters in max_clusters:
        ...
        np.savetxt(
            'output_folder/Results_{}_{}case_w={}_{}clusters_beta{}_lambda{}_{}_example_{}th_specific_region_.txt'  # _includingbay_scaler
            .format(dataset, case, window_size, num_clusters, beta, lambda_parameter, resample_interval, itt),
        ...
        for k in range(num_clusters):
            ...
            df_sensor_temp.loc[np.where(cluster_assignment == k)[0]]
        ...
        #             plt.xticks(idx_orig, idx_val)
        t += 1

    fig.tight_layout()
    plt.savefig(
        'output_folder/Results_{}_{}case_w={}_beta{}_lambda{}_{}_example_{}th_specific_region_.png'.format(dataset,
                                                                                                           case,
                                                                                                           window_size,
                                                                                                           beta,
                                                                                                           lambda_parameter,
...
dataset = 'dataset1'
case = [8]
window_size, max_clusters, beta, lambda_parameter = 5, [3, 4], 400, 11e-2
resample_interval = None  # '60T' # T=min
...
for num_clusters in max_clusters:
    input_file = 'output_folder/Results_{}_{}case_w={}_{}clusters_beta{}_lambda{}_{}_example_{}th_specific_region_.txt'.format(
    ...
    t += 1
plt.tight_layout()
plt.savefig('output_folder/Results_{}_{}case_w={}_beta{}_lambda{}_{}_example_{}th_specific_region.png'.format(dataset, case, window_size, beta,
